...
class TaskStepType(str, Enum):
    ...
    # 社区检测相关步骤
    COMMUNITY_CLEAR = "COMMUNITY_CLEAR"  # 清理现有社区数据
    COMMUNITY_PROJECTION = "COMMUNITY_PROJECTION"  # 创建图投影
    COMMUNITY_DETECTION = "COMMUNITY_DETECTION"  # 社区检测算法
    COMMUNITY_NODE_CREATION = "COMMUNITY_NODE_CREATION"  # 创建社区节点
    COMMUNITY_PROPERTY_CALCULATION = "COMMUNITY_PROPERTY_CALCULATION"  # 计算社区属性
    COMMUNITY_SUMMARY_GENERATION = "COMMUNITY_SUMMARY_GENERATION"  # 生成社区摘要
    COMMUNITY_EMBEDDING_CREATION = "COMMUNITY_EMBEDDING_CREATION"  # 创建社区嵌入向量
    COMMUNITY_INDEX_CREATION = "COMMUNITY_INDEX_CREATION"  # 创建社区索引
